...
def create_demo():
    ...
    # 创建示例图片
    sample_image = create_sample_essay_image()
    
    # 保存原始图片
    cv2.imwrite("sample_essay.png", sample_image)
    print("示例作文图片已保存为: sample_essay.png")
    ...
    # 处理图片
    processed_image = highlight_tool.process_image_with_highlights("sample_essay.png", highlight_data)
    ...
    # 保存最终结果
    cv2.imwrite("sample_essay_with_highlights.png", final_image)
    print("带高亮标记的示例图片已保存为: sample_essay_with_highlights.png")
    
    print("\n演示完成！")
    print("您可以查看以下文件：")
    print("- sample_essay.png: 原始英语作文图片")
    print("- sample_essay_with_highlights.png: 带高亮标记的图片")
